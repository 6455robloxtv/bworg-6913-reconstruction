...
if(toscroll) document.getElementById("logcontent").scrollTop = document.getElementById("logcontent").scrollHeight;
    ...
    BonziData = {
        ...
        event_list_joke_open: [
            ...
            [{ type: "text", text: "{NAME} asked me for funny comedy." }],
            ...
            [
                { type: "text", text: "Time to tell a funny bonkey joke!" },
            ],
            [
                { type: "text", text: "Its time for a joke, {NAME}." },
            ],
        ...
        event_list_joke_mid: [
            ...
            [
                { type: "text", text: "Why can't warsaw congratulate collage?" },
                { type: "text", text: "Because they are stupid!" },
            ],
            [
            ...
            [
                { type: "text", text: "I was a bonkey" },
                { type: "text", text: "For some reason we went extinct" },
            ],
            [
            ...
            [
                { type: "text", text: "Roblox is new these days, dont trust the new game, pet simulator!" }
            ],
            [
                { type: "text", text: "Why was bonziworld part discontinued?" },
                { type: "text", text: "Because the server shut down!" },
            ],
            [
            ...
            [
                { type: "text", text: "How many turkeys to eat all turkey seeds??" },
                { type: "text", text: "100!" },
            ],
            [
                { type: "text", text: "What do you call an racist owner?" },
                { type: "text", text: "Fune!" },
            ],
            [
                { type: "text", text: "Here's a joke:" },
                { type: "text", text: "bonseyworld" },
            ],
            [
                { type: "text", text: "Why did Fune get mad at sharty cuck?" },
                { type: "text", text: "sans." },
            ],
            [
                { type: "text", text: "I Like Racist stuff and know about the ronnie mcnutt incident and shit, who am i?" },
                { type: "text", text: "Liquid Fune!" },
            ],
            [
                { type: "text", text: "Why was 6 afraid of 7?" },
                { type: "text", text: "Because 7 vored 8 and people calls him a voretard everday!" },
            ],
            [
                { type: "text", text: "Why did the chicken cross the road?" },
                { type: "text", text: "To- AAAA CAR CRASH!" },
            ],
            [
            ...
            [
                { type: "text", text: "How do you get piano?" },
                { type: "text", text: "Virtual piano!" },
                { type: "text", text: "I'm a comedic genius, I know." },
            ],
        ],
        event_list_joke_end: [
            ...
            [
                { type: "text", text: "Tell that one to yourself!" },
            ],
            [
        ...
        event_list_fact_mid: [
            ...
            [
                { type: "anim", anim: "earth_fwd", ticks: 15 },
                { type: "text", text: "Did you know in the 90s, Space hoppers were popular!" },
                { type: "anim", anim: "earth_back", ticks: 15 },
                { type: "anim", anim: "grin_fwd", ticks: 15 },
            ],
            [
                { type: "anim", anim: "earth_fwd", ticks: 15 },
                { type: "text", text: "Top of the pops has music!" },
                { type: "anim", anim: "earth_back", ticks: 15 },
                { type: "anim", anim: "grin_fwd", ticks: 15 },
            ],
            [
                { type: "anim", anim: "earth_fwd", ticks: 15 },
                { type: "text", text: "Bonziworld classic is back, but enhanced? Cool!" },
                { type: "anim", anim: "earth_back", ticks: 15 },
                { type: "anim", anim: "grin_fwd", ticks: 15 },
            ],
            [
                { type: "anim", anim: "earth_fwd", ticks: 15 },
                { type: "text", text: "Fun fact, if you hack there is 100% chance you could get banned!" },
                { type: "anim", anim: "earth_back", ticks: 15 },
                { type: "anim", anim: "grin_fwd", ticks: 15 },
            ],
            [
                { type: "anim", anim: "earth_fwd", ticks: 15 },
                { type: "text", text: "Shartycuck was one of the flooders to flood bonziworld.org!" },
                { type: "anim", anim: "earth_back", ticks: 15 },
                { type: "anim", anim: "grin_fwd", ticks: 15 },
            ],
            [
                { type: "anim", anim: "earth_fwd", ticks: 15 },
                { type: "text", text: "Did you know theres a song called mcdonalds in the pentagon?" },
                { type: "anim", anim: "earth_back", ticks: 15 },
                { type: "anim", anim: "grin_fwd", ticks: 15 },
            ],
            [
                { type: "anim", anim: "earth_fwd", ticks: 15 },
                { type: "text", text: "did you know the warsaw community is toxic?" },
                { type: "anim", anim: "earth_back", ticks: 15 },
                { type: "anim", anim: "grin_fwd", ticks: 15 },
            ],
            [
                { type: "anim", anim: "earth_fwd", ticks: 15 },
                { type: "text", text: "did you know warsaw is liers!" },
                { type: "anim", anim: "earth_back", ticks: 15 },
                { type: "anim", anim: "grin_fwd", ticks: 15 },
            ],
            [
